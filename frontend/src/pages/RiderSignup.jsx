...
const RiderSignup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!files.license || !files.rc || !files.aadhar) {
        ...
        submitData.append('license', files.license);
        submitData.append('rc', files.rc);
        ...
        try {
            ...
            if (res.ok) {
                alert(data.message || 'Application submitted for approval.');
                navigate('/login');
            } else {
            ...
            <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-2xl w-full space-y-8 bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        {error && <div className="text-red-500 text-sm text-center bg-red-50 p-3 rounded-xl border border-red-100 font-medium">{error}</div>}
                        ...
                        {step === 1 && (
                            <div className="space-y-4 animate-fadeIn">
                                ...
                                <Button type="button" variant="primary" className="w-full mt-4" onClick={() => nextStep(2)}>Next: Vehicle Details</Button>
                            </div>
                        )}
