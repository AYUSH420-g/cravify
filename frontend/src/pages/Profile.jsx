...
const Profile = () => {
    ...
    const fetchOrders = async () => {
        try {
            ...
            if (res.ok) {
                setOrders(data);
                // Auto-prompt: Find the most recent delivered but unrated order
                const unratedOrder = data.find(o => o.status === 'Delivered' && !o.restaurantRating);
                if (unratedOrder && !isReviewModalOpen) {
                    setTimeout(() => {
                        setSelectedOrder(unratedOrder);
