                    ...
                    <div key={item.id} className="flex justify-between items-start text-sm">
                        ...
                        <div className="flex flex-col items-end gap-1">
                            <div className="flex items-center border border-gray-200 rounded px-2 py-0.5 font-bold text-green-600 bg-white shadow-sm">
                                <button onClick={() => updateQuantity(item.id, 'minus')} className="text-gray-400 hover:text-green-600 px-1">-</button>
                                <span className="mx-2 text-dark">{item.quantity}</span>
                                <button onClick={() => updateQuantity(item.id, 'plus')} className="text-green-600 px-1">+</button>
                            </div>
